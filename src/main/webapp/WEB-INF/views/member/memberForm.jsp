        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td><input type="text" name="memId" class="form-control input-sm"
                    ...
                    <button class="btn btn-info" type="button" id="idcheck">중복체크</button>
                </td>
            </tr>
            <tr>
                <th>비밀번호</th>
            ...
            <tr>
                ...
                <td><input type="email" name="memMail" class="form-control input-sm">
                    <button class="btn btn-info" type="button" id="emailCheck">이메일 확인</button>
                </td>
            </tr>
            <tr>
                <th>핸드폰</th>
...
<script>
    // html이 전부 만들어지고 난 뒤 실행됨
    $(document).ready(function () {
        // id가 빈 값이면 버튼 클릭 시 아무일도 일어나지 않음.
        // id가 값이 있으면 서버에 ajax 요청.
        // 서버에서는 id가 DB에 있는지 확인. 있으면 false, 없으면 true
        // 없을 때 alert (사용 가능한 아이디), 있을 때 alert(사용할 수 없는 아이디)
